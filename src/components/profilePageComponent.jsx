...
import Friendlist from "components/otherFriendList";
...
const ProfilePage = () => {
  ...
  return (
    <div className="h-full w-full">
      <div className="h-full w-full grid grid-cols-2 absolute top-0 bg-gray-50">
        <div className="col-span-1 w-1/2 pt-8 pl-2 md:pl-12 fixed top-12 left-0 h-full bg-gray-200">
          <div className="mx-2 md:mx-20">
            <div className="w-full md:w-4/5 ml-0 md:ml-12 mt-4 md:mt-0">
              <Ownercard />
            </div>
          </div>
        ...
        <div className="col-span-1 w-1/2 pr-1 md:pr-52 absolute h-full top-1 bg-gray-50 right-0">
          {loading ? (
            <div className="w-full h-full items-center border-x border-gray-300 mx-auto my-auto bg-gray-100  flex item-center justify-center">
              <div
                className="my-auto "
                role="status">
                <Spinner />
            ...
            <div className="border-x border-gray-300 pt-16 pb-1 pl-1 md:pl-0 pr-1 md:pr-0">
              {specificPosts.length === 0 ? (
                <div className="mt-20"><Lottie /></div>
              ) : (
                specificPosts.map(
                  (post, i) => (
                    <Feeds
