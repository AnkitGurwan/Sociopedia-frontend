...
const Navbar = () => {
      ...
      return (
          <header class="bg-blue-900 py-4 md:py-3 px-4 md:px-0 fixed w-full z-10">
            <nav class="container mx-auto flex items-center justify-between">
              ...
              <ul class="flex items-center">
                ...
                <li><Link to={`/profile/${user._id}`} class="text-white text-sm md:text-xl cursor-text px-2 md:px-4 font-bold">My Posts</Link></li>
